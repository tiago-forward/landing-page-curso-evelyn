    ...
    <footer className="w-full flex flex-col items-center justify-center transition-colors duration-500 bg-zinc-950 text-white gap-4 border-t border-zinc-950 py-10">
      <div className="w-full max-w-6xl m-auto flex flex-col items-center gap-4">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div>
            <p className="text-xs text-center">Desenvolvido por <span className="text-tertiary font-bold"><a href="https://www.linkedin.com/in/tiago-lacerda-devfrontend/" target="_blank" className="hover:underline">Tiago Forward</a></span></p>
          </div>
        </div>
      </div>
    </footer>
