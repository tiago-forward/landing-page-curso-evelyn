            ...
            <div className="relative max-w-6xl mx-auto flex flex-col items-center gap-8 p-4">
                <ul className="grid justify-center gap-14 font-robotoSlab mb-36 md:mb-40 lg:mb-44 lg:grid-cols-18x3">
                    {benefits.map((benefit) => (
                        <li key={benefit.id} className="flex flex-col items-center gap-8 py-4 px-4 rounded-3xl bg-pr-2">
                            ...
                            <h3 className="text-xl text-center font-bold lg:text-2xl">{benefit.title}</h3>
                            <p className="text-lg lg:text-xl">{benefit.description}</p>
                        </li>
                    ))}
                </ul>
                <div className="absolute bottom-[-10rem] flex flex-col gap-8 items-center bg-pr-2 rounded-xl p-6 w-full">
                    <p className="z-10 text-2xl text-center text-tertiary tracking-wider font-robotoSlab md:text-3xl lg:text-4xl lg:my-10">Não perca tempo e aproveite agora essa oportunidade</p>
