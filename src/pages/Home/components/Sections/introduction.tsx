    ...
    return (
        <div className="max-w-6xl mx-auto min-h-[79vh] p-4 pt-40">
            <div className="flex flex-col items-end">
                <h1 className="z-10 max-w-2xl mb-20 text-pr-1 text-4xl lg:text-5xl text-end font-bold font-gloock lg:tracking-wider">
            ...
            <div className="flex flex-col items-center justify-center gap-4">
                <p className="z-10 text-center text-lg text-amber-900 tracking-wider font-robotoSlab">Entre em contato comigo ou continue rolando para saber mais</p>
