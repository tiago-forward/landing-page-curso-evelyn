        ...
        <div className="max-w-6xl mx-auto min-h-[85vh] p-4 pt-20 lg:pt-40">
            <div className='flex flex-col items-center gap-4 lg:flex-row relative'>
                ...
                <div className="flex flex-col items-end">
                    <h1 className="max-w-2xl mb-20 text-pr-1 text-5xl text-end font-bold font-gloock lg:text-6xl lg:tracking-wider">
                        Curso Presencial onde irei te ajudar a <strong className="text-tertiary">faturar</strong> e aprender <strong className="text-tertiary">técnicas incríveis </strong> de maquiagem em apenas alguns minutos
                    </h1>
                </div>
            </div>
