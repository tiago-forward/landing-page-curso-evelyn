...
export function Introduction() {
    return (
        <div className="max-w-6xl mx-auto min-h-[85vh] p-4 pt-40">
            <div className='rounded-custom absolute bg-blue-700 w-[28rem] h-[28rem] overflow-hidden'>
                <div className='h-full w-full object-cover'><img className='absolute' src={ImageTeste} alt="" /></div>
            </div>
            ...
            <div className="flex flex-col items-end justify-center gap-4">
                <p className="z-10 text-lg text-amber-900 tracking-wider font-robotoSlab">Entre em contato comigo ou continue rolando para saber mais</p>
