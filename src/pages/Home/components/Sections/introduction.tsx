    ...
    return (
        <div className="max-w-6xl mx-auto min-h-[85vh] p-4 pt-20 lg:pt-40">
            ...
            <div className="flex flex-col items-center justify-center gap-4">
                <p className="z-10 text-2xl text-center text-tertiary tracking-wider font-robotoSlab md:text-3xl lg:text-4xl lg:my-10">Aprenda as técnicas avançadas de uma maquiadora profissional de sucesso</p>
