  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto p-4 flex flex-col items-center gap-4">
        ...
        <a href="https://wa.me/558388729460" target="_blank" className="uppercase bg-sr-2 w-full flex items-center justify-center gap-2 px-3 border-2 border-primary shadow-lg shadow-primary rounded-lg font-semibold font-robotoSlab text-xl tracking-widest duration-300 transform hover:scale-105 hover:bg-white hover:opacity-70 lg:w-fit">
          Agende agora
